...
class RitornelloFragment : Fragment() {

    private var module :Int? = 0
    private lateinit var compassoFragment: CompassoFragment
    ...
    override fun onCreateView(
        ...
        compassoFragment = CompassoFragment()
        val view = inflater.inflate(R.layout.fragment_ritornello, container, false)
        ...
        AlertDialog.Builder(requireContext())
            ...
            .setNegativeButton("REVISAR", DialogInterface.OnClickListener { _, _ ->
                activity?.supportFragmentManager?.beginTransaction()?.apply {
                    replace(R.id.container_lesson,compassoFragment)
                    commit()
                }
            }).show()
    }
